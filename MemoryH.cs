...
namespace Memory.Win32
{
    ...
    {
        Process process;
        public MemoryH32(Process TargetProcess)
        {
...
namespace Memory.Win64
{
    class MemoryH64
    {
        ...
        public MemoryH64(Process TargetProcess)
        {
            process = TargetProcess;
        }
...
namespace Memory.Utils
{
    ...
    {
        public static uint OffsetCalculator(Win32.MemoryH32 TargetMemory, uint BaseAddress, int[] Offsets)
        {
        ...
        public static ulong OffsetCalculator(Win64.MemoryH64 TargetMemory, ulong BaseAddress, int[] Offsets)
        {
            var address = BaseAddress;
            foreach (uint offset in Offsets)
            {
